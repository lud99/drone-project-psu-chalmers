...
class Speaker:
    ...
    def get_files_by_type(self, audio_type: str) -> list[AudioFile]:
        ...
        '''
        filtered_files = [
            audio_file for audio_file in self.audio_files 
    ...
    def has_type(self, audio_type: str) -> bool:
        ...
        return any(audio_file.audio_type == audio_type for audio_file in self.audio_files)
    
    def has_file(self, audio_file: str) -> bool:
        '''Returns True if the speaker has the specified audio file.'''
        return any(audio_file.audio_file == audio_file for audio_file in self.audio_files)
